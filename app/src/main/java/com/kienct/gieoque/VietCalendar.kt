...
object VietCalendar {
    ...
    private fun sunLongitudeAA98(jdn: Double): Double {
        ...
        val meanLongitude =
                280.46645 + 36000.76983 * julianTime + 0.0003032 * squareJulianTime // mean longitude, degree
        var dl =
                (1.914600 - 0.004817 * julianTime - 0.000014 * squareJulianTime) * sin(dr * meanAnomaly)
    ...
    private fun newMoonAA98(k: Int): Double {
        ...
        val dr = PI / 180
        var jd1 =
                2415020.75933 + 29.53058868 * k + 0.0001178 * squareJulianTime - 0.000000155 * cubicJulianTime
        jd1 += 0.00033 * sin((166.56 + 132.87 * julianTime - 0.009173 * squareJulianTime) * dr) // Mean new moon
        val sunMeanAnomaly =
                359.2242 + 29.10535608 * k - 0.0000333 * squareJulianTime - 0.00000347 * cubicJulianTime // Sun's mean anomaly
        val moonMeanAnomaly =
        ...
        var c1 =
                (0.1734 - 0.000393 * julianTime) * sin(sunMeanAnomaly * dr) + 0.0021 * sin(2 * dr * sunMeanAnomaly)
        ...
        c1 =
                c1 - 0.0074 * sin(dr * (sunMeanAnomaly - moonMeanAnomaly)) + 0.0004 * sin(dr * (2 * f + sunMeanAnomaly))
        c1 =
                c1 - 0.0004 * sin(dr * (2 * f - sunMeanAnomaly)) - 0.0006 * sin(dr * (2 * f + moonMeanAnomaly))
